...
const Index = () => {
    ...
    const loadBankAccounts = () => {
        axios.get(`v1/accounting/bank-accounts/gets-for-ddl`, {
            headers: {
    ...
    return (
        <MainSection title='Bank Account Ledger' breadcrumbPaths={[{name: 'Home', path: '/'}, {name: 'Dashboard', path: '/accounting'}]}>
            <div className='row'>

                {!resultShow ? (
                    <div className='col-md-6 offset-md-3'>
                        <FilterLedgers onChanged={onFilterHandler} options={options} headType={'Bank Account'}/>
                    </div>
                ) : (
                    <Fragment>
