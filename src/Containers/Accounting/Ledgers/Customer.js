...
const Index = () => {
    ...
    const loadInvestors = () => {
        axios.get(`v1/customers/gets-for-ddl`, {
            headers: {
    ...
    return (
        <MainSection title='Customer Ledger' breadcrumbPaths={[{name: 'Home', path: '/'}, {name: 'Dashboard', path: '/accounting'}]}>
            <div className='row'>

                {!resultShow ? (
                    <div className='col-md-6 offset-md-3'>
                        <FilterLedgers onChanged={onFilterHandler} options={options} headType={'Customer'}/>
                    </div>
                ) : (
                    <Fragment>
