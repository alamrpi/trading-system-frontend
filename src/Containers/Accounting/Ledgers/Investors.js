...
const Index = () => {
    ...
    const loadInvestors = () => {
        axios.get(`v1/accounting/investors/gets-for-ddl`, {
            headers: {
    ...
    return (
        <MainSection title='Investor Ledger' breadcrumbPaths={[{name: 'Home', path: '/'}, {name: 'Dashboard', path: '/accounting'}]}>
            <div className='row'>

                {!resultShow ? (
                    <div className='col-md-6 offset-md-3'>
                        <FilterLedgers onChanged={onFilterHandler} options={options} headType={'Investor'}/>
                    </div>
                ) : (
                    <Fragment>
