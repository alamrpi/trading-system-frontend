...
const CashFlows = () => {
    ...
    const loadStatements = () => {
        ...
        axios.get(`/v1/accounting/statements/cash-flows?${searchParams.toString()}`, {
            headers: {
    ...
    return (
        <MainSection title='Cash Flows' breadcrumbPaths={[{name: 'Home', path: '/'}, {name: 'Dashboard', path: '/accounting'}]}>
            <div className='row'>
                            ...
                            {data.rows.length === 0 ? (
                                ...
                                <div className='table-responsive'>
                                    <table className="table table-sm table-bordered">
                                        ...
                                        <tbody>
                                        {data.rows.map(({date, amount, operator, descriptions}, idx) => (
                                            <tr key={idx}>
