...
const Invoices = () => {
    ...
    const loadInvoices = (page) => {
        ...
        axios.get(`/v1/purchases/invoices?${searchParams.toString()}`, {
            headers: {
    ...
    const deleteProductHandler = () => {
        ...
        dispatch(openLoader());
        axios.post(`/v1/purchases/${selectedId}/delete`, null, {
        ...
        <MainSection title='Invoices'
            ...
            <div className='row'>
                <div className='col-md-12 pb-2'>
                    <Button variant='contained' size='small' onClick={() => navigate('/purchase-management/purchases/new')}><i
                    ...
                    {rows.length === 0 ? (
                        ...
                        <div className='table-responsive'>
                            <table className="table table-sm table-bordered">
                                ...
                                <tbody>
                                {rows.map(({id, invoiceNumber, supplierName, storeName, bankAccountName, date, paid}, idx) => (
                                    <tr key={id}>
                                        ...
                                        <td className='text-center'>
                                            <Dropdown
                                                ...
                                                menuItems={[
                                                    ...
                                                    {name: 'Purchase Return', onClicked: () => navigate(`/purchase-management/purchases/${id}/return/new`)},
