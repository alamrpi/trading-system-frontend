...
const AddOrUpdateBusiness = () => {
    ...
    const onFormSubmitHandler = (data) => {
      setLoading(true);
        ...
        axios.post(path, data, {
            ...
            navigate('/stock-inventory/stores', {replace: true});
        }).catch(error => {
    ...
    return (
        <MainSection
            ...
            breadcrumbPaths={[{name: 'Home', path: '/'}, {name: 'Dashboard', path: '/stock-inventory'}, {name: 'Stores', path: '/stock-inventory/stores'}]}
        >
            <div className='row'>
