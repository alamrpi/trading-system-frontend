...
const ReturnProducts = ({openModal, products, totalPrice, removedProduct}) => {
            ...
            <div className='card mb-2'>
                <div className='card-body'>
                    ...
                    <table className='table table-sm table-bordered'>
                        ...
                        <tbody>
                        {products.map(({productName, qty, unitVariationName, price}, idx) => (
                            <tr key={idx}>
                                ...
                                <td className="text-end">{qty * price}</td>
